...
class gravity_model(object):
    ...
    def exponent_matrix(
        ...
        Args:
            ...
            bin_mode (str, optional): binning method. Defaults to "equal_bin".
    ...
    def preprocess_data(self, rmin, rmax):
    ...
    def divide_bins(self, mbins, rbins, bin_mode="equal_num"):
        # Population binning
    ...
    def calculate_matrix(self, mbins, rbins, binning):
    ...
    def calculate_exponent(self, mobility_pair: pd.DataFrame, rbins, binning):
